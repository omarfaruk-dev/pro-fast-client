...
const SendParcel = () => {
    ...
    // Defensive: ensure serviceCenters is always an array
    const centersArray = Array.isArray(serviceCenters) ? serviceCenters : [];

    // Extract unique regions
    const uniqueRegions = [...new Set(centersArray.map((w) => w.region))];
    // Get districts by region
    const getDistrictsByRegion = (region) =>
        centersArray.filter((w) => w.region === region).map((w) => w.district);
