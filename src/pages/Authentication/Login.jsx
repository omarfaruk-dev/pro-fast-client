            ...
            <div className="bg-white p-10">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className=" mb-4">
                        ...
                        <input type="email" {...register("email", { required: true })} placeholder="Email" className="input input-bordered w-full rounded-md focus:outline-none focus:ring-1 focus:ring-secondary" />
                        {
